        ...
        <div class="admin-page">
            <div class="admin-page__header">
                <div class="admin-page__title">
                    <h2>Categories</h2>
                    <p class="admin-page__subtitle">Organize and manage product categories</p>
                </div>
            ...
            <div class="admin-toolbar">
                <div class="admin-toolbar__left">
                    <span class="admin-badge">Total: <c:out value="${fn:length(categories)}"/></span>
                </div>
                <div class="admin-toolbar__right">
                    <input type="search" id="categorySearch" class="admin-search-input" placeholder="Search by category name">
                </div>
            </div>
            ...
            <div class="orders_container">
                <div class="form-container">
                    <h4>Add Category</h4>
                    <form id="addProductForm" action="/addCategory" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="name">Category Name:</label>
                            <input type="text" id="name" name="name" required>
                        </div>

                        <button type="submit" id="refreshTable">Add Category</button>
                    </form>
            ...
            <div class="admin-table-wrapper" style="margin-top: 30px;">
                <table class="admin-table" id="categoriesTable">
                    ...
                    <c:forEach var="category" items="${categories}">
                        <tr data-row>
                            <td class="admin-table__cell--number"><span data-id="${category.id}">${category.id}</span></td>
                            <td data-name>${category.name}</td>
                            <td>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        if (searchInput) {
            searchInput.addEventListener("input", () => {
                ...
                document.querySelectorAll("#categoriesTable tbody tr[data-row]").forEach(row => {
